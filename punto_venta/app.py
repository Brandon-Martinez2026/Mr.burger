...
class MenuPrincipal(tk.Tk):
    ...
    def __init__(self, id_usuario=None, nombre_cajero=None):
        ...
        # Sesión real del cajero que inició sesión con sus
        # credenciales en IniciarSesion.py (usuario/contraseña,
        # validadas contra la tabla "usuarios"). id_usuario es lo
        # que se guarda en cada pedido (pedidos.id_usuario).
    ...
    def crear_sidebar(self):
        ...
        inicial = (self.cajero_actual or "?")[0].upper()
