...
class MenuAdministrador(tk.Tk):
    ...
    def __init__(self):
        ...
        # Repositorio de productos/categorías (ver nota en
        # panel_admin/datos_admin.py: datos de ejemplo en memoria,
        # sin conexión a base de datos todavía).
    ...
    def crear_sidebar(self):
        ...
        avatar.create_text(24, 24, text="A", font=("Segoe UI", 18, "bold"), fill=ROJO)

        datos = tk.Frame(usuario, bg=ROJO_OSCURO)
        datos.pack(side="left", pady=15)

        tk.Label(
            datos, text=ADMIN_ACTUAL, font=("Segoe UI", 12, "bold"), fg="white", bg=ROJO_OSCURO
        ).pack(anchor="w")
